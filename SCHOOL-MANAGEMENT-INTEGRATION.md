...
Use a hosted form service, Google Apps Script web app, or your school management API as that endpoint. The endpoint must accept browser form submissions from `https://toddlerlearner.com/`.
